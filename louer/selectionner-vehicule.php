...
<head>
    ...
    <script type="module" type="text/javascript">
        ...
        document.getElementById('btn-ok').onclick = async function() {
            ...
            await $.ajax({
                url: '../php/carGet.php', // Récupère la voiture
                type: 'GET',
        ...
        <div>
            ...
            <div class="right-container">
                <div class="container-element">
                    ...
                    <input type="number" name="NbPlV" id="selectionner-vehicule-nombre-place" min='1' value="<?php echo isset($_SESSION['vehicule
                ']['NbPlV']) ? $_SESSION['vehicule
                ']['NbPlV'] : '1' ?>" />
                </div>
                <div class="container-element">
                    <label for="selectionner-vehicule-puissance">Puissance</label>
                    <input type="number" name="PuisV" id="selectionner-vehicule-puissance" min="0" value="<?php echo isset($_SESSION['vehicule
                ']['PuisV']) ? $_SESSION['vehicule
                ']['PuisV'] : '0' ?>" />

                </div>
                <div class="container-element">
                    <label for="selectionner-vehicule-marque">Marque </label>
                    <input type="text" name="MarV" id="selectionner-vehicule-marque" list="marque-list" value="<?php echo isset($_SESSION['vehicule
                ']['MarV']) ? $_SESSION['vehicule
                ']['MarV'] : '' ?>" />
                ...
                <div class="container-element">
                    ...
                    <input type="text" name="ModV" id="selectionner-vehicule-modele" list="modele-list" value="<?php echo isset($_SESSION['vehicule
                ']['ModV']) ? $_SESSION['vehicule
                ']['ModV'] : '' ?>" />
                ...
                <div class="container-element">
                    ...
                    <input type="text" name="CoulV" id="selectionner-vehicule-couleur" list="couleur-list" value="<?php echo isset($_SESSION['vehicule
                ']['CoulV']) ? $_SESSION['vehicule
                ']['CoulV'] : '' ?>" />
