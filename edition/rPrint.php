<?php
require('fpdf/fpdf.php'); // Assurez-vous que le chemin vers la bibliothèque FPDF est correct
...
class PDF extends FPDF {
    function Header() {
        ...
        $this->Cell(0,10,'Rapport de Location de Véhicules',0,1,'C');
        $this->Ln(5);
        
        // En-têtes de colonnes
        $this->SetFont('Arial','B',10);
        $this->Cell(40,10,'Code Client',1);
        $this->Cell(40,10,'Matricule Véhicule',1);
        $this->Cell(40,10,'Date Début',1);
